...
public class FileUserStatusRepository implements UserStatusRepository {
    ...
    public FileUserStatusRepository(@Value("${discodeit.repository.file-directory:repository}") String FILE_DIR) {
        this.DIRECTORY = Paths.get(System.getProperty("user.dir"), FILE_DIR, UserStatus.class.getSimpleName());
